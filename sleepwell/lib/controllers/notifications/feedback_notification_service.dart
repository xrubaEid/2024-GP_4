...
//  جلب البيانات من Firebase للأيام السبعة الماضية ثم
// التحقق من تكرار الأسباب للأيام السبعة الماضية على حسب إجابات المستخدم للأسئلة
// إذا كانت جودة النوم Poor أو Average لثلاثة أيام أو أكثر من أيام الأسبوع
// يتم التحقق من    الأسباب التي تكررت 3 مرات أو أكثر ويتم
// إرسال إشعار بناءً على الأسباب المتكررة مع التوصيات المناسبة لكل سبب

// وإذا كانت جودة النوم Good يرسل إشعار أن جودة نومة جيدة ولضمان استمرار نومة بالطرقة الصحيحة يتبع النظظام الذي يتخه للنوم
    // تحليل البيانات
